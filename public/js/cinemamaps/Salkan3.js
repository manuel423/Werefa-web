...
$(document).ready(function () {
    ...
    var $cart = $("#selected-seats"),
        ...
        sc = $("#seat-map").seatCharts({
            map: [
                "eeeee_eeee___eeeee_eeeeeee_",
                "eeeee_eeeeee_eeeee_eeeeeeee",
                "eeee__eeeee__eeeee_eeeeeeee",
                "eeee__eeee___eeee__eeeeee_-",
                "eeee__eeee___eeee__eeeee___",
                "_____________eeee__eeeee___",
                "___eeeeeeeeeeeeeee_________",
            ],
            seats: {
                f: {
                    price: vprice,

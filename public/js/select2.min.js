...
!(function (n) {
    ...
    var e = (function () {
            ...
            return (
                ...
                e.define("select2/results", ["jquery", "./utils"], function (
                    h,
                    f
                ) {
                    function i(e, t, n) {
                ...
                e.define("select2/selection/eventRelay", ["jquery"], function (
                    o
                ) {
                    function e() {}
                    return (
                ...
                e.define("select2/data/tokenizer", ["jquery"], function (d) {
                    ...
                    return (
                        ...
                        (e.prototype.query = function (e, t, n) {
                            var i = this;
                            t.term = t.term || "";
                            var r = this.tokenizer(t, this.options, function (
                                e
                            ) {
                ...
                e.define("select2/dropdown", ["jquery", "./utils"], function (
                    t,
                    e
                ) {
                    function n(e, t) {
                                ...
                                this.on("open", function () {
                                    ...
                                    this.on("query", function (t) {
                                        n.isOpen() || n.trigger("open", {}),
                                            this.dataAdapter.query(t, function (
                                                e
                                            ) {

    ...
    $.fn.seatCharts = function (setup) {
            ...
            seat = (function (seatCharts, seatChartsSettings) {
                return function (setup) {
                    ...
                    (function (seatSettings, character, seat) {
                        ...
                        $.each(["click", "focus", "blur"], function (
                            index,
                            callback
                        ) {
                            ...
                            fn[callback] = function () {
                                ...
                                return fn.style(
                                    typeof seatSettings[character][callback] ===
                                        "function"
                                        ? seatSettings[character][
                                              callback
                                          ].apply(seat)
                                        : seatChartsSettings[callback].apply(
                                              seat
                                          )
                                );
                            };
        ...
        settings.legend.items.length
            ? (function (legend) {
                  ...
                  var $ul = $("<ul></ul>").addClass("row").appendTo($container);
                                  ...
                                  $("<div></div>")
                                      ...
                                      .addClass(
                                          [
                                              ...
                                              .concat(
                                                  settings.classes,
                                                  typeof settings.seats[
                                                      item[0]
                                                  ] == "undefined"
                                                      ? []
                                                      : settings.seats[item[0]]
                                                            .classes
                                              )
                                              .join(" ")
                                      )
